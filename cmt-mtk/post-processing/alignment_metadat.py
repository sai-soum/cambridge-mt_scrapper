...
class AudioProcessor:
    def __init__(self, song_path):
        ...
        self.aligned_folder = opj(os.path.dirname(song_path), "aligned")
    ...
    def get_rough_sum(self, multitrack_folder):
        ...
        if drys:
            ...
            rough_sum = sum(drys)
            filename = os.path.basename(multitrack_folder).replace("multitrack", "rough_mix.wav")
...
if __name__ == "__main__":
    ...
    for song_path in tqdm(song_paths, desc="Processing songs"):
        ...
        if excerpt_rough_mix or full_rough_mix:
